...
void CheckingNumber(string number){
  if (number[0]==number[4] || number[0]==number[3]){
...
double segmentLength =  Math.Pow (Decision(x1, x2, y1, y2, z1, z2), 2 );

Console.WriteLine($"Длина отрезка  {segmentLength} сантиметров");*/
